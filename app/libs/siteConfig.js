...
const siteConfig = {
    ...
    checkoutLink: "https://buy.stripe.com/9B6cN5h0D3174Tx4msfAc07?prefilled_promo_code=30OFFNOW",
    buyerCount: "205",
    oldPrice: "$47",
    discountedPrice: "$17",
    totalDicount: "$30",
  ...
  // add a nightly counter of buyers that updates?
  // webhook and amplitude event for each purcahse