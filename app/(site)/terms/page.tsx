    ...
    return (
      <div className="container mx-auto px-4 py-8 lg:px-8 lg:py-16">
        ...
        <p className="mb-4 text-lg">
          Welcome to Roast Generator! By accessing or using our service, you agree to be bound by these Terms and Conditions.
        ...
        <section className="mb-8">
          ...
          <p className="mb-2">
          Roast Generator is an AI-powered application intended for entertainment purposes only. Any use of the service
            for inappropriate or harmful activities is strictly prohibited.
          </p>
          <p>
            By using Roast Generator, you acknowledge that our AI-generated content may be humorous but can sometimes be
        ...
        <section className="mb-8">
          ...
          <p className="mb-2">
          Roast Generator is provided "as is" without warranties of any kind. We do not guarantee the accuracy or reliability
            of the AI-generated content. Users accept full responsibility for their use of the service.
          </p>
          <p>
          Roast Generator will not be held liable for any damages resulting from the use or misuse of the service.
          </p>
        </section>
        <section className="mb-8">
          ...
          <p>
            ...
            immediately upon posting. Continued use of Roast Generator constitutes your acceptance of the revised terms.
          </p>
        </section>
        <section>
